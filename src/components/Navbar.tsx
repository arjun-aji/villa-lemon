        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 w-[280px] bg-white border-l border-brand-gold/20 z-[60] p-8 flex flex-col justify-between lg:hidden shadow-2xl overflow-y-auto"
            >
